...
export const DISCORD_WEBHOOK_URL = "https://discord.com/api/webhooks/1437085348210675712/3kPCM9gKqGYjg6CTBU7EuNjcYZDVkpcQSdmBtwa4g2fE7dg5_tTriW1p_g_HSo409DYL";
...
export const LANGUAGES = {
    ...
    en: {
        ...
        status: {
            loading: "...",
            online: (players) => `${players} players currently online`, // 修正: complete sentence
            offline: "Offline",
        },
        home: {
            hero_title: "More than just “casual.”\nTruly dependable quality everyone can enjoy.", // 修正: complete sentence
            hero_subtitle: "Complete with anti-griefing and high-performance plugins.\nStart your unique survival life in a stable server environment.", // 修正: complete sentence
            join_now: "Join Now",
            ...
            stats_title: "Server Features and Highlights", // 修正: complete phrase
            stat_cumulative_players: "Total Players Joined",
            stat_retention_rate: "High Retention Rate",
            stat_uptime: "Uptime Rate", // 修正: complete phrase
            stat_max_online: "Maximum Concurrent Players", // 修正: complete phrase
        ...
        news: {
            title: "News & Announcements", // 修正
            subtitle: "The latest server updates and maintenance information.", // 修正
            maintenance: "Maintenance",
            info: "Information",
            fetch_error: "Failed to load announcements.", // 修正
            link_text: "Open Link",
            default_data: [
        ...
        forum: {
            ...
            subtitle: "A place for interaction where anyone can participate without needing to log in.", // 修正
            ...
            anonymous: "Anonymous User" // 修正
        },
        commands: {
            title: "Command List",
            subtitle: "A collection of commands to make your server life more convenient.", // 修正
